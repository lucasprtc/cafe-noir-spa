...
export default function Navbar() {
  ...
  return (
    <>
      <nav
        className={`bg-dark-blue mx-4 lg:mx-0 fixed top-4 lg:top-0 left-0 right-0 z-50 transition-all duration-300
          h-fit ${isVisible ? 'translate-y-0' : '-translate-y-full'} lg:rounded-none rounded-[10px]`}
      >
