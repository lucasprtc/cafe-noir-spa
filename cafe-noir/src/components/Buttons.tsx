...
const Button: React.FC<ButtonProps> = ({ 
  ...
  const baseClasses = `inline-block text-lg md:text-xl w-fit px-5 md:px-8 py-3 py-4 rounded-[5px] cursor-pointer font-primary transition-colors duration-200 leading-6 leading-8 ${selectedColor}`;
